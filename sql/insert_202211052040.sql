INSERT INTO Forum.appartenir (topic_id,categorie_id) VALUES
	 (1,1),
	 (2,2);
...
INSERT INTO Forum.topic (titre,dateCreation,statut,utilisateur_id) VALUES
	 ('Send data from server to client with vanilla nodejs and javascript','2022-11-05 19:59:08',0,1),
	 ('How to place "deleted" objects into an array?','2022-11-05 20:01:21',1,1);
